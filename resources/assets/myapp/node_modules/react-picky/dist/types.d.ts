export declare type SimpleOptionType = string | number;
export declare type ComplexOptionType = {
    [key: string]: any;
};
export declare type OptionType<T = any> = T extends string ? SimpleOptionType : T extends number ? SimpleOptionType : ComplexOptionType;
export declare type OptionsType = OptionType[];
export declare type SelectAllMode = 'default' | 'filtered';
/**
...
export declare type SelectionState = 'none' | 'partial' | 'all';
